...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0(Vtop___024root* vlSelf) {
    ...
    while (VL_LIKELY(!vlSymsp->_vm_contextp__->gotFinish())) {
        VL_WRITEF_NX("ram's age: %0x\n",0,32,VlAssocArray<std::string, IData/*31:0*/>()
                     .set("ram"s, 0x00000028U).set("sita"s, 
                                                   0x00000023U)
                     .at("ram"s));
        VL_WRITEF_NX("ram's age: %0x\n",0,32,VlAssocArray<std::string, IData/*31:0*/>()
                     .set("ram"s, 0x00000028U).set("sita"s, 
    ...
    do {
...
#endif
            VL_FATAL_MT("assoc.sv", 1, "", "DIDNOTCONVERGE: NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("assoc.sv", 1, "", "DIDNOTCONVERGE: Active region did not converge after 100 tries");
            }
