...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.top__DOT__arr.renew(0x0000000aU);
    vlSelfRef.top__DOT__arr.atWrite(3U) = 0x14U;
    VL_WRITEF_NX("%0x\n",0,8,vlSelfRef.top__DOT__arr.at(3U));
    co_await vlSelfRef.__VdlySched.delay(0x00000000000000c8ULL, 
                                         nullptr, "dyn_array.sv", 
                                         10);
    top__DOT__unnamedblk1__DOT__i = 0U;
    while (VL_LTS_III(32, top__DOT__unnamedblk1__DOT__i, vlSelfRef.top__DOT__arr.size())) {
        VL_WRITEF_NX("%0x\n",0,8,vlSelfRef.top__DOT__arr.at(top__DOT__unnamedblk1__DOT__i));
    ...
    do {
...
#endif
            VL_FATAL_MT("dyn_array.sv", 1, "", "DIDNOTCONVERGE: NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("dyn_array.sv", 1, "", "DIDNOTCONVERGE: Active region did not converge after 100 tries");
            }
