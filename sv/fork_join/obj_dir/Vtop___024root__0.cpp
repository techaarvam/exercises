...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0(Vtop___024root* vlSelf) {
    ...
    co_await __Vfork_1__sync.join(nullptr, "fork.sv", 
                                  6);
    VL_WRITEF_NX("%0t after fork-join\n",0,64,VL_TIME_UNITED_Q(1),
                 -12);
    co_return;}
...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0____Vfork_1__1(Vtop___024root* vlSelf, VlForkSync __Vfork_1__sync) {
    ...
    co_await vlSelfRef.__VdlySched.delay(0x0000000000000014ULL, 
                                         nullptr, "fork.sv", 
                                         13);
    VL_WRITEF_NX("%0t thread B\n",0,64,VL_TIME_UNITED_Q(1),
                 -12);
    __Vfork_1__sync.done("fork.sv", 12);
    co_return;}
...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0____Vfork_1__0(Vtop___024root* vlSelf, VlForkSync __Vfork_1__sync) {
    ...
    co_await vlSelfRef.__VdlySched.delay(0x000000000000000aULL, 
                                         nullptr, "fork.sv", 
                                         8);
    VL_WRITEF_NX("%0t thread A\n",0,64,VL_TIME_UNITED_Q(1),
                 -12);
    __Vfork_1__sync.done("fork.sv", 7);
    co_return;}
    ...
    do {
...
#endif
            VL_FATAL_MT("fork.sv", 1, "", "DIDNOTCONVERGE: NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("fork.sv", 1, "", "DIDNOTCONVERGE: Active region did not converge after 100 tries");
            }
