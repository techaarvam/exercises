...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0(Vtop___024root* vlSelf) {
    ...
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "struct.sv", 
                                         19);
    vlSelfRef.top__DOT__t__BRA__39__03a32__KET__ = 0x41U;
    co_await vlSelfRef.__VdlySched.delay(0x000000000000000aULL, 
                                         nullptr, "struct.sv", 
                                         21);
    vlSelfRef.top__DOT__t__BRA__31__03a0__KET__ = 0xfffe7960U;
    co_await vlSelfRef.__VdlySched.delay(0x000000000000012cULL, 
                                         nullptr, "struct.sv", 
                                         23);
    VL_FINISH_MT("struct.sv", 23, "");
    co_return;}
...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__1(Vtop___024root* vlSelf) {
    ...
    while (VL_LIKELY(!vlSymsp->_vm_contextp__->gotFinish())) {
        co_await vlSelfRef.__VdlySched.delay(0x000000000000000aULL, 
                                             ...
                                             "struct.sv", 
                                             11);
        VL_WRITEF_NX("%x %x\n",0,8,vlSelfRef.top__DOT__t__BRA__39__03a32__KET__,
                     32,vlSelfRef.top__DOT__t__BRA__31__03a0__KET__);
        vlSelfRef.top__DOT__t__BRA__31__03a0__KET__ 
            = ((IData)(1U) + vlSelfRef.top__DOT__t__BRA__31__03a0__KET__);
    }
    co_return;}
    ...
    do {
...
#endif
            VL_FATAL_MT("struct.sv", 8, "", "DIDNOTCONVERGE: NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("struct.sv", 8, "", "DIDNOTCONVERGE: Active region did not converge after 100 tries");
            }
