...
VlCoroutine Vtop___024root___eval_initial__TOP__Vtiming__0(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_WRITEF_NX("integer i = 0\nint     j = 0\n",0);
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "int_vs_integer.sv", 
                                         21);
    VL_FINISH_MT("int_vs_integer.sv", 21, "");
    co_return;}
    ...
    do {
...
#endif
            VL_FATAL_MT("int_vs_integer.sv", 9, "", "DIDNOTCONVERGE: NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("int_vs_integer.sv", 9, "", "DIDNOTCONVERGE: Active region did not converge after 100 tries");
            }
